...
title: "CNS Lab Assignment 4: SDES"
...
![Example text file encryption and decryption](111703013_sdes_output.png)

![Encryption and decryption of pdf file, and time needed using "time"
command](111703013_sdes_times.png)

![Encryption times](encryption_times.png)

![Decryption times](decryption_times.png)

## Statistics

The file used for encryption is a pdf file having size **546KB**

The average time needed for encryption (4 repetitions) is **0.8832s**.
